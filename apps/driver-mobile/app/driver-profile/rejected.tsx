// Path: goviet247/apps/driver-mobile/app/driver-profile/rejected.tsx
...
export default function DriverProfileRejectedScreen() {
    ...
    async function loadData() {
      try {
        ...
        if (token) {
          ...
          const reason = String(
            profileData?.profile?.rejectReason || ""
          ).trim();
        ...
        console.warn("load rejected profile data error:", error);
      } finally {
        setLoading(false);
      }
    }
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>Hồ sơ bị từ chối</Text>

          <Text style={styles.subtitle}>
            Hồ sơ tài xế của bạn chưa được duyệt. Vui lòng xem lý do bên dưới
            và liên hệ {brandName || "GoViet247"} nếu cần hỗ trợ.
          </Text>
          ...
          <View style={styles.reasonBox}>
            ...
            {loading ? (
              ...
              <Text style={styles.reasonText}>
                {rejectReason ||
                  "Hồ sơ chưa đáp ứng yêu cầu xét duyệt. Vui lòng liên hệ GoViet247 để được hỗ trợ."}
              </Text>
            )}
          </View>
          ...
          <View style={styles.supportBox}>
            ...
            {supportPhone ? (
              <Text style={styles.supportText}>Hotline/Zalo: {supportPhone}</Text>
            ) : null}
